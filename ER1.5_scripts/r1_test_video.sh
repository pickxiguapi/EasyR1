...
TRAIN_FILES="[rft_train_datasets/ER1.5_Cosmos_video_qa.json,rft_train_datasets/ER1.5_general_video_qa.json]"
CONFIG=ER1.5_scripts/20260210_test.yaml
MODEL_PATH=/apdcephfs_wza/cientgu/iffyuan/models/Embodied-R1.5-SFT-0128
IMAGE_DIR=/apdcephfs_wza/cientgu/iffyuan/Embodied-R1.5-RFT/0210/data
ROLLOUT_BS=512
GEN_BS=128
GLOBAL_BS=256
MB_PER_UPDATE=4
